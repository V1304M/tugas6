...
model = load_model(r'C:\KULIAH\Semester 5\Machine Learning\Tugas6_B_11685\model_mobilenet.h5')
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga 1685")  # 4 digit npm terakhir
...
if st.sidebar.button("Prediksi"):
    if uploaded_files:
        ...
        st.sidebar.error("Kesalahan saat memproses gambar {uploaded_file.name}: {confidence}")
else:
    st.sidebar.error(f"Silahkan unggah setidaknya satu gambar untuk diprediksi.")
